...
Objects(3) = R_Object("Objects/Parts/Tonic_Water",0.1,0.3,transl(0.2,0.6,0.4),"Large")

Objects(4) = R_Object("Objects/Parts/Shaker_Top",0.0415,0.075,transl(0.0,0.6,0.4),"Large")

Objects(5) = R_Object("Objects/Parts/Shaker_Bottom",0.0415,0.151,transl(-0.2,0.6,0.4),"Large")

Objects(6) = R_Object("Objects/Parts/Gin",0.043,0.221,transl(-0.4,0.6,0.4),"Large")
